package com.angular.admin.dao.cache.redis;
...
public class ShardedJedisSentinelPool  extends Pool<ShardedJedis> {
    ...
    public ShardedJedisSentinelPool(final GenericObjectPoolConfig poolConfig, String strmasters, String strsentinels) {
        this(strmasters, strsentinels, poolConfig, Protocol.DEFAULT_TIMEOUT, null,
                Protocol.DEFAULT_DATABASE);
    }
    public ShardedJedisSentinelPool(String strmasters, String strsentinels,
        ...
        List<String> masters = Arrays.asList(StringUtils.trimToEmpty(strmasters).split(","));
        Set<String>  sentinels = new HashSet<>();
        for(String str: StringUtils.trimToEmpty(strsentinels).split(",")){
            sentinels.add(str);
        }
